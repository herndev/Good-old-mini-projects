...
# usr.sort()
# for x in usr:
# 	insertdata("bank",{"name":x,"money":"0"})

# insertdata("bank",{"name":"Beauty","money":"0"})
# createdb('shortcut')
# createtb('data',['project','directory'])
# insertdata('data',{'project':'powerups','directory':'/home/syntaxer/Documents/Projects/Python/Powerups/'})
# print(selectdata('data',{'project':'powerups'}))
